...
const UI_TEXT = {
  "zh": {
    "brandTitle": "精神状态速测台",
    "brandSub": "生活场景题 · 每次48题 · 答完就吐槽",
    "homeTitle": "选个场景，测测你平时怎么活",
    "homeLead": "题目都是生活场景，选项像人话。每次48题，答一题吐槽一句，测完给锐评和匹配。",
    "startBtn": "开始快问快答",
    "previewTypes": "先看增强图鉴",
    "nickTitle": "给自己起个节目名",
    ...
    "feature1Text": "不整假大空问卷腔，题干短、选项口语，更像你日常会遇到的选择。",
    ...
    "researcher": "场控小喇叭",
    "researcherLine": "我是小喇叭。你选完我就吐槽，金句和锐评包在售后里。",
    "traitsTitle": "关键词",
    "strengthsTitle": "优势雷达",
    "watchoutsTitle": "注意点",
    "growthTitle": "成长建议",
  ...
  "en": {
    ...
    "brandSub": "Life scenes · 48 picks · instant roast",
    "homeTitle": "Pick a scene, see how you move",
    "homeLead": "Short real-life scenes, spoken options, instant roast after each pick.",
